    ...
    <div className={businessProfileStyles.pageContainer}>
      ...
      <div className={businessProfileStyles.headerContainer}>
        ...
        <p className={businessProfileStyles.headerSubtitle}>
          Manage your business details, branding, and digital assets for invoices.
        </p>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-8">
        ...
        <div className={businessProfileStyles.cardContainer}>
          ...
          <div className={businessProfileStyles.gridCols2}>
            ...
            <div className={businessProfileStyles.gridColSpan2}>
              ...
              <textarea
                rows={3}
                placeholder="123 Business Rd, Suite 100, City, State 12345"
                value={meta.address || ""}
                onChange={(e) => updateMeta("address", e.target.value)}
                className={`${businessProfileStyles.textarea} ${customStyles.inputPlaceholder}`}
              />
            </div>
          </div>
        </div>
                ...
                {previews.stamp ? (
                  <div className={businessProfileStyles.imagePreviewContainer}>
                    <div className={businessProfileStyles.stampPreview}>
                      <img src={previews.stamp} alt="stamp preview" className="object-contain w-full h-full" onError={(e) => { e.currentTarget.style.display = "none"; }} />
                    </div>
                    <div className={businessProfileStyles.buttonGroup}>
                      <label className={businessProfileStyles.changeButton}>
                        <UploadIcon className="w-4 h-4" /> Change
            ...
            <div>
                ...
                {previews.signature ? (
                  <div className={businessProfileStyles.imagePreviewContainer}>
                    <div className={businessProfileStyles.signaturePreview}>
                      <img src={previews.signature} alt="signature preview" className="object-contain w-full h-full" onError={(e) => { e.currentTarget.style.display = "none"; }} />
                    </div>
                    <div className={businessProfileStyles.buttonGroup}>
                      <label className={businessProfileStyles.changeButton}>
                        <UploadIcon className="w-4 h-4" /> Change
              ...
              <div className="mt-6 space-y-4">
                <div>
                  ...
                  <input placeholder="John Doe" value={meta.signatureOwnerName || ""} onChange={(e) => updateMeta("signatureOwnerName", e.target.value)} className={`${businessProfileStyles.input} ${customStyles.inputPlaceholder}`} />
                </div>
                <div>
                  <label className={businessProfileStyles.label}>Signature Title / Designation</label>
                  <input placeholder="Director / CEO" value={meta.signatureOwnerTitle || ""} onChange={(e) => updateMeta("signatureOwnerTitle", e.target.value)} className={`${businessProfileStyles.input} ${customStyles.inputPlaceholder}`} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={businessProfileStyles.cardContainer}>
          <div className={businessProfileStyles.gridCols2}>
            ...
            <div>
              <label className={businessProfileStyles.label}>Notes (appear on invoices)</label>
              <textarea
                rows={3}
      ...
      <ConfirmModal
        ...
        onConfirm={doClearProfile}
        title="Clear Profile"
        message="Clear current profile data? This cannot be undone."
        confirmLabel="Clear"
        danger
      />
    </div>
